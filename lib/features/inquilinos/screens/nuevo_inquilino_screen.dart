...
class NuevoInquilinoScreen extends StatefulWidget {
  ...
  @override
  State<NuevoInquilinoScreen> createState() => _NuevoInquilinoScreenState();
}

class _NuevoInquilinoScreenState extends State<NuevoInquilinoScreen> {
  ...
  // Estado (activo por default al crear)
  ...
  final _diaPagoCtrl         = TextEditingController(text: '1');
  final _incrementoAnualCtrl = TextEditingController(text: '0.00');
  ...
  final _fiscalRazonSocialCtrl = TextEditingController();
  final _fiscalRfcCtrl         = TextEditingController();
  final _fiscalCpCtrl          = TextEditingController();
  final _fiscalCorreoCtrl      = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const AppHeader(title: 'Nuevo Inquilino', showBack: true),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Expanded(
            child: Text(
              'Opcional. Necesario para emitir facturas CFDI al inquilino.',
              style: TextStyle(
