...
class _InicioUsuarioScreenState extends State<InicioUsuarioScreen> {
  ...
  // ── Datos del chart ────────────────────────────────────────────────────────
  static const List<_ChartData> _chartData = [
    _ChartData('Ene', 24000),
    _ChartData('Feb', 22100),
    _ChartData('Mar', 22900),
    _ChartData('Abr', 20000),
    _ChartData('May', 21810),
    _ChartData('Jun', 25000),
    _ChartData('Jul', 21000),
  ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: const [
          ...
          SizedBox(height: 4),
          Text(
            'Aquí tienes el resumen de tus propiedades.',
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: chartData
                        ...
                        .entries
                        .map((e) =>
                            FlSpot(e.key.toDouble(), e.value.value / 1000))
                        .toList(),
                    isCurved: true,
                    ...
                    belowBarData: BarAreaData(
                      ...
                      gradient: LinearGradient(
                        colors: [
                          const Color(0xFF1695A3).withOpacity(0.3),
